pub mod bip_39 {
	...
	pub fn get(word_index: usize) -> String {
		let const_word_list_array = [
		...
		if word_index > 2047 {
			...
			String::from(const_word_list_array[word_index])
		}
	}
}
...
#[test]
fn exist_word_test() {
	assert_eq!("advice", bip_39::get(32))
}
#[test]
fn last_word_test() {
	assert_eq!("zoo", bip_39::get(2047))
}
#[test]
fn not_exist_word_test() {
	assert_eq!("-", bip_39::get(2048))
}
